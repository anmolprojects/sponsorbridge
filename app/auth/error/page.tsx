...
import { Mail, Lock, Sparkles, ArrowRight, Shield, AlertCircle } from "lucide-react"
...
export default function CreatorLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (!profile) {
      // New user via email — create profile
      ...
      await supabase.from("creator_profiles").insert({ id: data.user.id } as any)
      router.push("/creator/dashboard?welcome=true")
      return
    }

    if (profile.role !== "creator") {
      setError("This email is registered as a Company account. Use Company Login.")
      ...
      <div className="hidden lg:flex flex-1 bg-[#0D0D0B] items-center justify-center p-12">
        <div className="max-w-md text-center">
          ...
          <p className="text-[#FAFAF7]/70 mb-8">
            Access AI-matched brand deals, escrow-protected payments, and keep
            95% of every deal.
          </p>
