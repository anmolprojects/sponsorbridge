        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              The smartest bridge between creators and companies. AI-powered, escrow-protected, lowest fees.
            </p>
          </div>
          ...
          {/* Creator Links */}
          <div>
            <h4 className="font-medium text-foreground mb-4">Creators</h4>
            <ul className="space-y-3">
          ...
          {/* Company Links */}
          <div>
            <h4 className="font-medium text-foreground mb-4">Companies</h4>
            <ul className="space-y-3">
